...
class WPComponent__admin
{
	...
	public function __construct(){
		...
		add_action('admin_menu', array( $this, 'wpcomponent__init' ) );

        add_action("wp_ajax_wpcomponent__setSetting", array( $this, "wpcomponent__setSetting") );
        add_action("wp_ajax_nopriv_wpcomponent__setSetting", array( $this, "wpcomponent__setSetting") );

	}

	public function wpcomponent__init(){
		add_submenu_page(
			'options-general.php',
			'WPComponent',
			'WPComponent',
			'manage_options',
			'wpcomponent',
			array( $this, 'wpcomponent__render' )
			// plugins_url( '../front/image/wpcomponent-icon-16.png' , dirname(__FILE__) ),
			// 89
		);
	...
	public function wpcomponent__setSetting(){
	...
	public function wpcomponent__render(){
		$options = $this->wpcomponent_getSettings();
    ?>
    <div class="wpc__admin wpc__admin--wrapper">

	    <header class="wpc__admin--header">
	    	<h1>
...
<!-- 				<div class="wpc__admin--card">
			...
			<div class="wpc__admin__tabs wpc__admin__tabs--importexport">
			...
			<!-- Checkup current dev -->
<!-- 			<div class="wpc__admin__tabs wpc__admin__tabs--checkup">
