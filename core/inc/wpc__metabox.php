<?php
class WPComponent__metabox
{

    public function __construct()
    {
        load_textdomain('wpcomponent', WPC_DIR . 'lang/wpc-' . get_locale() . '.mo');
        add_action( 'add_meta_boxes', array($this, 'wpc__addMetaBox__Sidebar') );
    }

    public function wpc__addMetaBox__Sidebar(){
        ...
        foreach ( $screens as $screen ) {
            ...
            if( get_option( $option_filter . $screen ) != 'false' ){
                add_meta_box(
                    ...
                    array($this, 'wpc__addMetaBox__Sidebar__callback'),
                    $screen,
                    'side',
                    'core'
                );
    ...
    public function wpc__addMetaBox__Sidebar__callback(){
        ...
        $wpc_structure = new WPComponent__structure();
        $theme_template = $wpc_structure->WPComponent__register__Theme__folder();
        $plugin_template = $wpc_structure->WPComponent__register__Plugin__folder();
        ...
        ?>
        <select id="wpcomponent__folder__selector">
            <?php
